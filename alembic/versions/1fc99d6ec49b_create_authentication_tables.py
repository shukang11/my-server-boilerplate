...
Revision ID: 1fc99d6ec49b
Revises:
Create Date: 2024-04-15 16:39:57.816914
...
def upgrade() -> None:
    ...
    op.create_table(
        "user_token",
        sa.Column("user_id", sa.Integer(), nullable=False, comment="admin_user id"),
